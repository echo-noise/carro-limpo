(function (za, O, l) {
  var N = function (h) {
    ...
    function N(a) {
      ...
      !a.sEmptyTable &&
        c &&
        "Nenhuma entrada na tabela" === b.sEmptyTable &&
    ...
    function P(a, b, c, d) {
      ...
      d &&
        (c +=
          ". Para mais informações sobre erros, entre em contato com o suporte." +
          d);
    ...
    p.defaults = {
      ...
      oLanguage: {
        ...
        sInfo: "Exibindo  _END_ de _TOTAL_.",
        ...
        sSearch: "Procurar: ",
        sSearchPlaceholder: "O que você procura?",
        sUrl: "",
    ...
    h.extend(p.ext.classes, {
      ...
      sFilterInput: "form-datatable",
      sLengthSelect: "form-datatable", 
