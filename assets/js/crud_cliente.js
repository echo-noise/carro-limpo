$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            '<td><input type="text" scope="col" class="form-control-crud" name="nome" id="nome" maxlength="20" >Nome</td>' +
         
						'<td><input type="text" scope="col" class="form-control-crud"  name="telefone" maxlength="14"  id="telefone">Telefone</td>' +
         
						'<td><input type="email" scope="col" class="form-control-crud" name="email" maxlength="20" id="email">E-mail</td>' +
					
						'<td><input type="text" scope="col" class="form-control-crud" name"cpf_cnpj" maxlength="14" id="cpf_cnpj">CPF/CNPJ</td>' +
