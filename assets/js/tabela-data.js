...
(function (d) {
  ...
  var g,
    q = function (a, b) {
      ...
      var c = this.c.i18n;
      if (!g && "DD/MM/YYYY" !== this.c.format)
        throw "DateTime: Without momentjs, dayjs or luxon only the format 'DD/MM/YYYY' can be used";
      ...
      this.s = {
        ...
        parts: {
          date: null !== this.c.format.match(/[DMY]|L(?!T)|l/),
  ...
  q.defaults = {
    ...
    i18n: {
      ...
      weekdays: "Dom Seg Ter Qua Qui Sex Sab".split(" "),
      amPm: ["am", "pm"],
      hours: "Hora",
      minutes: "Minuto",
      seconds: "Segundos",
